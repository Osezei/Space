      ...
      <div className="container relative">
        ...
        <div className="block lg:grid lg:grid-cols-2">
          <div className="mt-5 lg:mt-10 flex justify-center">
            <h3 className="text-sm lg:text-2xl  text-home uppercase lg:w-full">
              <span className="text-home text-[#d0d6f976] pr-2 ">01</span> Pick
              your destination
            </h3>
          </div>

          <div className="flex justify-center mt-[300px] lg:justify-start  text-sm lg:mt-24">
            ...
            ({
              ...
              return (
                <article key={id} className="">
                  {toggled === id ? (
                    <div className=" mt-[10px] grid-rows-2 place-items-center lg:grid grid-cols-2 ">
                      <div className=" w-[220px] lg:w-[450px] lg:mt-5 lg:ml-6 absolute top-[150px] left-[80px]">
                      ...
                      <div className="">
                        ...
                        <p className="top-wording text-sm leading-loose text-center">
                          {note}
                        </p>
                        <div className="my-8 lg:mt-14 lg:mb-10 w-[350px] h-[0.05rem] lg:w-[36rem] bg-[#d0d6f976] mx-auto"></div>
